...
protected:
    ...
    void readHandler(const boost::system::error_code& ec, std::size_t bytes_transferred, uint64_t connectId);
    void writeHandler(const boost::system::error_code &ec, std::size_t bytes_transferred, uint64_t connectId);
